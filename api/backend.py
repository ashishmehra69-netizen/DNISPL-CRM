...
def init_db() -> None:
    ...
    try:
        with conn.cursor() as cur:
            ...
            cur.execute("UPDATE users SET email = 'shashank.raturi@dnispl.com' WHERE lower(email) = 'shasank.raturi@dnispl.com' AND NOT EXISTS (SELECT 1 FROM users WHERE lower(email) = 'shashank.raturi@dnispl.com');")
